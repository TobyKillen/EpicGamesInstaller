...
parser = argparse.ArgumentParser(description='EPIC Games Reinstaller Tool - Developed on Windows, for Windows.')
parser.add_argument('--path', '--path', help="Specifiy Path to your EPIC Folder", type= str)
